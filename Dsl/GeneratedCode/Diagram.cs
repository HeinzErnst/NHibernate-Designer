...
[module: global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1506:AvoidExcessiveClassCoupling", Scope = "type", Target = "BrainTec.NHibernateDesigner.NHibernateDesignerDiagram")]

namespace BrainTec.NHibernateDesigner
{
	/// <summary>
	/// DomainClass NHibernateDesignerDiagram
	/// Description for BrainTec.NHibernateDesigner.NHibernateDesignerDiagram
	/// </summary>
	[DslDesign::DisplayNameResource("BrainTec.NHibernateDesigner.NHibernateDesignerDiagram.DisplayName", typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel), "BrainTec.NHibernateDesigner.GeneratedCode.DomainModelResx")]
	[DslDesign::DescriptionResource("BrainTec.NHibernateDesigner.NHibernateDesignerDiagram.Description", typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel), "BrainTec.NHibernateDesigner.GeneratedCode.DomainModelResx")]
	[DslModeling::DomainModelOwner(typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel))]
	[global::System.CLSCompliant(true)]
	[DslModeling::DomainObjectId("afcf1004-5d1b-47a0-9afd-07e2c55dc978")]
	public partial class NHibernateDesignerDiagram : DslDiagrams::Diagram
	{
		...
		private static global::System.ComponentModel.ToolboxItemFilterAttribute[] toolboxFilters = new global::System.ComponentModel.ToolboxItemFilterAttribute[] {
					new global::System.ComponentModel.ToolboxItemFilterAttribute(global::BrainTec.NHibernateDesigner.NHibernateDesignerToolboxHelperBase.ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) };
		...
		{
			if(element is global::BrainTec.NHibernateDesigner.ExampleElement)
			{
				global::BrainTec.NHibernateDesigner.ExampleShape newShape = new global::BrainTec.NHibernateDesigner.ExampleShape(this.Partition);
				if(newShape != null) newShape.Size = newShape.DefaultSize; // set default shape size
				return newShape;
			}
			if(element is global::BrainTec.NHibernateDesigner.ExampleElementReferencesTargets)
			{
				global::BrainTec.NHibernateDesigner.ExampleConnector newShape = new global::BrainTec.NHibernateDesigner.ExampleConnector(this.Partition);
				return newShape;
			}
		...
		protected override void InitializeShapeFields(global::System.Collections.Generic.IList<DslDiagrams::ShapeField> shapeFields)
		{
			...
			global::BrainTec.NHibernateDesigner.ExampleShape.DecoratorsInitialized += ExampleShapeDecoratorMap.OnDecoratorsInitialized;
		}
		...
		internal static partial class ExampleShapeDecoratorMap
		{
			...
			public static void OnDecoratorsInitialized(object sender, global::System.EventArgs e)
			{
				...
				propertyInfo = new DslDiagrams::AssociatedPropertyInfo(global::BrainTec.NHibernateDesigner.ExampleElement.NameDomainPropertyId);
		...
		private global::BrainTec.NHibernateDesigner.ExampleRelationshipConnectAction exampleRelationshipConnectAction;
		/// <summary>
		...
		public override void OnViewMouseEnter(DslDiagrams::DiagramPointEventArgs pointArgs)
		{
			...
			if(activeView != null)
			{
				...
				if (SelectedToolboxItemSupportsFilterString(activeView, global::BrainTec.NHibernateDesigner.NHibernateDesignerToolboxHelper.ExampleRelationshipFilterString))
				{
					if (this.exampleRelationshipConnectAction == null)
					{
						this.exampleRelationshipConnectAction = new global::BrainTec.NHibernateDesigner.ExampleRelationshipConnectAction(this);
		...
		/// <summary>
		/// NHibernateDesignerDiagram domain class Id.
		/// </summary>
		public static readonly new global::System.Guid DomainClassId = new global::System.Guid(0xafcf1004, 0x5d1b, 0x47a0, 0x9a, 0xfd, 0x07, 0xe2, 0xc5, 0x5d, 0xc9, 0x78);
		/// <summary>
		/// Constructor
		/// </summary>
		/// <param name="store">Store where new element is to be created.</param>
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public NHibernateDesignerDiagram(DslModeling::Store store, params DslModeling::PropertyAssignment[] propertyAssignments)
		...
		/// <param name="propertyAssignments">List of domain property id/value pairs to set once the element is created.</param>
		public NHibernateDesignerDiagram(DslModeling::Partition partition, params DslModeling::PropertyAssignment[] propertyAssignments)
...
namespace BrainTec.NHibernateDesigner
{
		...
		/// </summary>
		[DslModeling::RuleOn(typeof(global::BrainTec.NHibernateDesigner.ExampleElement), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddShapeParentExistRulePriority, InitiallyDisabled=true)]
		[DslModeling::RuleOn(typeof(global::BrainTec.NHibernateDesigner.ExampleElementReferencesTargets), FireTime = DslModeling::TimeToFire.TopLevelCommit, Priority = DslDiagrams::DiagramFixupConstants.AddConnectionRulePriority, InitiallyDisabled=true)]
		internal sealed partial class FixUpDiagram : FixUpDiagramBase
		{
			...
			public override void ElementAdded(DslModeling::ElementAddedEventArgs e)
			{
				...
				if(childElement is global::BrainTec.NHibernateDesigner.ExampleElement)
				{
					parentElement = GetParentForExampleElement((global::BrainTec.NHibernateDesigner.ExampleElement)childElement);
				} else
				{
					parentElement = null;
				}
			...
			public static global::BrainTec.NHibernateDesigner.ExampleModel GetParentForExampleElement( global::BrainTec.NHibernateDesigner.ExampleElement root )
			{
				// Segments 0 and 1
				global::BrainTec.NHibernateDesigner.ExampleModel result = root.ExampleModel;
		...
		internal sealed class ConnectorRolePlayerChanged : DslModeling::RolePlayerChangeRule
		{
			...
			public override void RolePlayerChanged(DslModeling::RolePlayerChangedEventArgs e)
			{
				...
				foreach (DslDiagrams::PresentationViewsSubject connectorLink in connectorLinks)
				{
					...
					if (linkShape != null)
					{
						global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram diagram = linkShape.Diagram as global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram;
						if (diagram != null)
						{
