...
namespace BrainTec.NHibernateDesigner
{
	...
	public static partial class ExampleElementReferencesTargetsBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::BrainTec.NHibernateDesigner.ExampleElement)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			{
				if (candidateSource is global::BrainTec.NHibernateDesigner.ExampleElement)
				{
					if (candidateTarget is global::BrainTec.NHibernateDesigner.ExampleElement)
					{
						global::BrainTec.NHibernateDesigner.ExampleElement sourceExampleElement = (global::BrainTec.NHibernateDesigner.ExampleElement)candidateSource;
						global::BrainTec.NHibernateDesigner.ExampleElement targetExampleElement = (global::BrainTec.NHibernateDesigner.ExampleElement)candidateTarget;
						if(targetExampleElement == null || sourceExampleElement == null || global::BrainTec.NHibernateDesigner.ExampleElementReferencesTargets.GetLinks(sourceExampleElement, targetExampleElement).Count > 0) return false;
						return true;
					}
				}
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			{
				if (source is global::BrainTec.NHibernateDesigner.ExampleElement)
				{
					if (target is global::BrainTec.NHibernateDesigner.ExampleElement)
					{
						global::BrainTec.NHibernateDesigner.ExampleElement sourceAccepted = (global::BrainTec.NHibernateDesigner.ExampleElement)source;
						global::BrainTec.NHibernateDesigner.ExampleElement targetAccepted = (global::BrainTec.NHibernateDesigner.ExampleElement)target;
						DslModeling::ElementLink result = new global::BrainTec.NHibernateDesigner.ExampleElementReferencesTargets(sourceAccepted, targetAccepted);
