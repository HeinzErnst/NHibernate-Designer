...
namespace BrainTec.NHibernateDesigner
{
	...
	/// </remarks>
	public partial class NHibernateDesignerHelpKeywordHelper : NHibernateDesignerHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new NHibernateDesignerHelpKeywordHelper.
		/// </summary>
		protected NHibernateDesignerHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the NHibernateDesignerHelpKeywordHelper.
		/// </summary>
		public static NHibernateDesignerHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class NHibernateDesignerHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new NHibernateDesignerHelpKeywordHelperBase.
		/// </summary>
		protected NHibernateDesignerHelpKeywordHelperBase()
			: base() { }
