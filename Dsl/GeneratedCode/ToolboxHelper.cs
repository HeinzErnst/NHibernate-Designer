...
namespace BrainTec.NHibernateDesigner
{
	...
	/// </remarks>
	public partial class NHibernateDesignerToolboxHelper : NHibernateDesignerToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerToolboxHelper.
		/// </summary>
		public NHibernateDesignerToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class NHibernateDesignerToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify NHibernateDesigner toolbox items.  
		/// </summary>
		/// <remarks>
		/// See the MSDN documentation for the ToolboxItemFilterAttribute class for more information on toolbox
		/// item filters.
		/// </remarks>
		public const string ToolboxFilterString = "NHibernateDesigner.1.0";
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NHibernateDesignerToolboxHelperBase.
		/// </summary>
		protected NHibernateDesignerToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public static string DefaultToolboxTabName
		{
			get
			{
				return global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("NHibernateDesignerToolboxTab", global::System.Globalization.CultureInfo.CurrentUICulture);
			}
		}
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager;
			global::System.Globalization.CultureInfo resourceCulture = global::System.Globalization.CultureInfo.CurrentUICulture;
			switch(itemId)
			{
				case "BrainTec.NHibernateDesigner.ExampleElementToolboxItem":
					// Add ExampleElement shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"BrainTec.NHibernateDesigner.ExampleElementToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						...
						"BrainTec.NHibernateDesigner.NHibernateDesignerToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("NHibernateDesignerToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::BrainTec.NHibernateDesigner.ExampleElement.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "BrainTec.NHibernateDesigner.ExampleRelationshipToolboxItem":

					// Add ExampleRelationship connector tool.
					result = new DslDesign::ModelingToolboxItem(
						"BrainTec.NHibernateDesigner.ExampleRelationshipToolboxItem", // Unique identifier (non-localized) for the toolbox item.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel));
