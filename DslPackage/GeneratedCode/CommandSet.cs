...
namespace BrainTec.NHibernateDesigner
{
	...
	/// </summary>
	internal partial class NHibernateDesignerCommandSet : NHibernateDesignerCommandSetBase
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerCommandSet.
		/// </summary>
		public NHibernateDesignerCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class NHibernateDesignerCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerCommandSetBase.
		/// </summary>
		protected NHibernateDesignerCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewNHibernateDesignerExplorerCommand,
				typeof(NHibernateDesignerEditorFactory).GUID);
		...
		{
			NHibernateDesignerExplorerToolWindow explorer = this.NHibernateDesignerExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected NHibernateDesignerDocData CurrentNHibernateDesignerDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as NHibernateDesignerDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected NHibernateDesignerDocView CurrentNHibernateDesignerDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as NHibernateDesignerDocView;
			}
		}
		...
		/// </summary>
		protected NHibernateDesignerExplorerToolWindow NHibernateDesignerExplorerToolWindow
		{
			get
			{
				NHibernateDesignerExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(NHibernateDesignerExplorerToolWindow), true) as NHibernateDesignerExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				NHibernateDesignerExplorerToolWindow explorerWindow = this.NHibernateDesignerExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class NHibernateDesignerClipboardCommandSet : NHibernateDesignerClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerClipboardCommandSet.
		/// </summary>
		public NHibernateDesignerClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class NHibernateDesignerClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerClipboardCommandSetBase.
		/// </summary>
		protected NHibernateDesignerClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
