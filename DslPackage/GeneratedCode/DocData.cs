...
namespace BrainTec.NHibernateDesigner
{
	...
	/// </summary>
	internal partial class NHibernateDesignerDocData : NHibernateDesignerDocDataBase
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerDocData.
		/// </summary>
		public NHibernateDesignerDocData(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) 
	...
	/// <summary>
	/// Class which represents a NHibernateDesigner document in memory.
	/// </summary>
	internal abstract partial class NHibernateDesignerDocDataBase : DslShell::ModelingDocData
	{
		/// <summary>
		...
		/// <summary>
		/// Constructs a new NHibernateDesignerDocDataBase.
		/// </summary>
		protected NHibernateDesignerDocDataBase(global::System.IServiceProvider serviceProvider, global::System.Guid editorFactoryId) : base(serviceProvider, editorFactoryId)
		{
		}
		...
		protected override string FormatList
		{
			get
			{
				return global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("FormatList"); 
			}
		}
		...
		protected virtual bool HandleBindingFailure(global::System.Exception exception)
		{
			...
			string errorMessage = string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
				global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("BindingErrorOccurred"),
				exception.ToString());
		...
		protected override global::System.Collections.Generic.IList<global::System.Type> GetDomainModels()
		{
			...
			allTypes.Add(typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel));
		...
		protected virtual global::System.Collections.Generic.IEnumerable<global::System.Type> GetExtensionDomainModels()
		{
			...
			global::System.Collections.Generic.IEnumerable<global::System.Type> extensionDomainModels = this.ExtensionLocator.GetExtendingDomainModels(typeof(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel));
		...
		protected override void Load(string fileName, bool isReload)
		{
			...
			global::BrainTec.NHibernateDesigner.ExampleModel modelRoot = null;
			...
			global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.EnableDiagramRules(this.Store);
			string diagramFileName = fileName + this.DiagramExtension;
			
			modelRoot = global::BrainTec.NHibernateDesigner.NHibernateDesignerSerializationHelper.Instance.LoadModelAndDiagram(serializationResult, this.GetModelPartition(), fileName, this.GetDiagramPartition(), diagramFileName, schemaResolver, null /* no load-time validation */, this.SerializerLocator);
			...
			{	
				...
				throw new global::System.InvalidOperationException(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("CannotOpenDocument"));
			}
			else
			{
						...
						if (itemId != global::Microsoft.VisualStudio.VSConstants.VSITEMID_NIL)
						{
							...
							if (this.diagramDocumentLockHolder == null)
							{
								throw new global::System.InvalidOperationException(string.Format(global::System.Globalization.CultureInfo.CurrentCulture,
													global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("CannotCloseExistingDiagramDocument"),
													diagramFileName));
							}
						}
					}
		...
		{
			DslModeling::SerializationResult serializationResult = new DslModeling::SerializationResult();
			global::BrainTec.NHibernateDesigner.ExampleModel modelRoot = (global::BrainTec.NHibernateDesigner.ExampleModel)this.RootElement;
			...
			{
				global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram diagram = diagrams[0] as global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram;
				if (diagram != null)
				{
					string diagramFileName = fileName + this.DiagramExtension;
					try
					{
						...
						global::BrainTec.NHibernateDesigner.NHibernateDesignerSerializationHelper.Instance.SaveModelAndDiagram(serializationResult, modelRoot, fileName, diagram, diagramFileName, this.Encoding, false);
					}
					finally
					{
			...
			{
				global::BrainTec.NHibernateDesigner.NHibernateDesignerSerializationHelper.Instance.SaveModel(serializationResult, modelRoot, fileName, this.Encoding, false);
			}
			// Report serialization messages.
			this.SuspendErrorListRefresh();
			try
			...
			if (serializationResult.Failed)
			{	// Save failed.
				throw new global::System.InvalidOperationException(global::BrainTec.NHibernateDesigner.NHibernateDesignerDomainModel.SingletonResourceManager.GetString("CannotSaveDocument"));
			}
		}
		/// <summary>
			...
			if (diagrams.Count > 0)
			{
				...
				if (diagram != null)
				{
					try
					{
						...
						global::BrainTec.NHibernateDesigner.NHibernateDesignerSerializationHelper.Instance.SaveDiagram(serializationResult, diagram, fileName, this.Encoding, false);
					}
					finally
					{
		...
		protected override string SerializedModel
		{
			get
			{
				global::BrainTec.NHibernateDesigner.ExampleModel modelRoot = this.RootElement as global::BrainTec.NHibernateDesigner.ExampleModel;
				string modelFile = string.Empty;
				if (modelRoot != null)
				{
					modelFile = global::BrainTec.NHibernateDesigner.NHibernateDesignerSerializationHelper.Instance.GetSerializedModelString(modelRoot, this.Encoding);
				}
				return modelFile;
			}
		}
