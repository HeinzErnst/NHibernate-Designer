...
namespace BrainTec.NHibernateDesigner
{
	...
	/// </summary>
	internal partial class NHibernateDesignerDocView : NHibernateDesignerDocViewBase
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerDocView.
		/// </summary>
		public NHibernateDesignerDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class NHibernateDesignerDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new NHibernateDesignerDocView.
		/// </summary>
		protected NHibernateDesignerDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			NHibernateDesignerDocDataBase docData = this.DocData as NHibernateDesignerDocDataBase;
			global::System.Diagnostics.Debug.Assert(docData != null, "DocData for NHibernateDesignerDocViewBase should be an NHibernateDesignerDocDataBase!");
			DslModeling::Partition diagramPartition = docData.GetDiagramPartition();
			if (diagramPartition != null)
			{
				global::System.Collections.ObjectModel.ReadOnlyCollection<global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram> diagrams = docData.GetDiagramPartition().ElementDirectory.FindElements<global::BrainTec.NHibernateDesigner.NHibernateDesignerDiagram>();
				if (diagrams.Count > 0)
				{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::BrainTec.NHibernateDesigner.NHibernateDesignerToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::BrainTec.NHibernateDesigner.NHibernateDesignerToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuId
		{
			get
			{
				return Constants.NHibernateDesignerDiagramMenu;
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::BrainTec.NHibernateDesigner.NHibernateDesignerHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::BrainTec.NHibernateDesigner.NHibernateDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::BrainTec.NHibernateDesigner.NHibernateDesignerHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
